...
//  MexicoInteligente
//
//  Created by Jorge Espinoza on 15/02/26.
//
        ...
        ZStack(alignment: .top) {
            ...
            ScrollView {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        VStack {
                            ...
                            Text("8")
                                ...
                                .frame(maxWidth: .infinity)
                                .foregroundColor(Colors.greenStatus)
                                .multilineTextAlignment(.center)
                        ...
                        VStack {
                            ...
                            VStack {
                                ...
                                Text("51")
                                    ...
                                    .frame(maxWidth: .infinity)
                                    .foregroundColor(Colors.blueProteccion)
                                    .multilineTextAlignment(.center)
                    ...
                    //OperationsResumeContent2(countActive: "8", countClose: "51", countRenovation: "0")
...
struct OperationsResumeContent2: View {
